...
public class SummaryData {
    private double rata_rata_bmi;
    private double aktivitas;
    private double total_karbohidrat;
    ...
    public void setRata_rata_bmi(double rata_rata_bmi) {
        this.rata_rata_bmi = rata_rata_bmi;
    }
    ...
    public double getTotal_karbohidrat() {
        return total_karbohidrat;
    }

    public void setTotal_karbohidrat(double total_karbohidrat) {
        this.total_karbohidrat = total_karbohidrat;
    }
    ...
    public double getTotal_garam() {
        return total_garam;
    }

    public void setTotal_garam(double total_garam) {
        this.total_garam = total_garam;
    }

    public double getTotal_gula() {
        return total_gula;
    }

    public void setTotal_gula(double total_gula) {
